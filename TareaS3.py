...
class Ejercicios_Tarea2:
    ...
    def libros(self):
        ...
        #Escribir un programa que especifique el ingreso de una cantidad indeterminada de números mayores que 1, finalizando 
        #cuando reciba un cero.
    ...
    def primos(self):
        ...
        print("Cantidad total de números primos es ", a)

        #Escribir un programa que permita al usuario ingresar dos años y luego imprimir todos los años en ese rango que sean bisiesto y múltiplos de 10
    def bisiesto(self):
        ...
        #Determine cuál es la salida en pantalla si ingresa los valores x = 6, y =7 ¿qué sucede si los nombres de los parámetros dentro de la función se
    ...
    def número(self):
        ...
        print(máximo(x-3, mínimo(x+2,y-5)))
    ...
    def eje2(self):
        ...
        #Al día(s/n). El programa debe iniciar con los datos de los socios fundadores ya cargados:
        ...
        def cargarsocios(socios):
            numero = int(input("Número de socio(0 para cerrar): "))
            while numero != 0:
                nombre = input("Nombre y Apellido: ")
                fecha = input("Fecha de ingreso(fecha completa sin separación ): ")
                cuota = input("¿Cuota al día? (s para si, n para no) s/n: ")
                pago = cuota.lower()=="s"
        ...
        numero = int(input("Número de socios: "))
